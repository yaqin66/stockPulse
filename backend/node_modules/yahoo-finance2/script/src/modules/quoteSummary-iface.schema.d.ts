    ...
    namespace definitions {
        ...
        namespace Price {
            ...
            export namespace properties_52 {
                ...
                export namespace overnightMarketChangePercent {
                    let type_400: string;
                    export { type_400 as type };
                }
                export namespace overnightMarketChange {
                    let type_401: string;
                    export { type_401 as type };
                }
                export namespace overnightMarketTime {
                    let type_402: string;
                    export { type_402 as type };
                    let format_24: string;
                    export { format_24 as format };
                }
                export namespace overnightMarketPrice {
                    let type_403: string;
                    export { type_403 as type };
                }
                export namespace overnightMarketSource {
                    let type_404: string;
...
//# sourceMappingURL=quoteSummary-iface.schema.d.ts.map